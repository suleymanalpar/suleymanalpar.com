...
const translations = {
  tr: {
    ...
    'hero.subtitle': 'Tıp Doktoru | Sağlık Hukuku Uzmanı | Senarist',
    'hero.tagline': '"Bilim, hukuk ve hikayenin kesiştiği noktada"',
    'hero.badge1': 'Tıp Doktoru',
    'hero.badge2': 'Sağlık Hukuku',
    'hero.badge3': 'Senarist',
    'hero.badge4': 'Bilimsel Yazar',
    'hero.cta1': 'Hastalar İçin',
    'hero.cta2': 'Öğrenciler İçin',

    // Sections
    'services.label': 'HİZMETLER',
    'services.title': 'Neler Sunuyorum?',
    'services.desc': 'Tıp, hukuk ve yaratıcı yazarlık alanlarında uzmanlaşmış hizmetler',
    ...
    'services.student.title': 'Öğrenci Kaynakları',
    'services.student.desc': 'Tıp öğrencileri için ders notları, vaka çalışmaları ve akademik kaynaklar.',
    'services.blog.title': 'Blog & Makaleler',
    'services.blog.desc': 'Sağlık hukuku, tıbbi etik ve bilimsel konularda derinlemesine yazılar.',
    'services.scenario.title': 'Senaryo & Hikaye',
    'services.scenario.desc': 'Tıbbi dramalar, sağlık hikayeleri ve yaratıcı yazarlık projeleri.',
    'services.more': 'Devamını oku →',

    // About
    'about.label': 'HAKKIMDA',
    'about.title': 'Dr. Süleyman Alpar Kimdir?',
    'about.p1': 'Tıp doktorluğu ve sağlık hukuku uzmanlığını bir araya getiren, aynı zamanda senaryo yazarlığı ve hikaye anlatıcılığı alanlarında aktif olan çok yönlü bir profesyonelim.',
    'about.p2': 'Hem hastalarıma en iyi sağlık bilgisini sunmayı, hem öğrencilerime güçlü bir akademik temel oluşturmayı, hem de hikayelerle insanlara dokunmayı hedefliyorum.',
    ...
    'blog.desc': 'Sağlık, hukuk ve hikaye dünyasından en güncel yazılar',
    'blog.cat1': 'Sağlık Hukuku',
    'blog.cat2': 'Tıbbi Etik',
    'blog.cat3': 'Bilimsel Araştırma',
    'blog.title1': 'Hasta Hakları ve Güncel Mevzuat Değişiklikleri',
    'blog.desc1': 'Son dönemde sağlık hukukunda yaşanan önemli değişiklikler ve hastaların bilmesi gerekenler.',
    ...
    // Footer
    'footer.desc': 'Tıp, hukuk ve hikaye anlatıcılığının kesişiminde bilgi ve ilham sunan kişisel web sitesi.',
    ...
    'student.note2.title': 'Sağlık Hukuku Dersleri',
    'student.note2.desc': 'Tıbbi malpraktis, hasta hakları, hekim sorumluluğu ve sağlık mevzuatı.',
    'student.note2.tag': 'Hukuk',
    ...
    'student.career3.title': 'Sağlık Hukuku Uzmanlığı',
    'student.career3.desc': 'Tıp ve hukuk disiplinlerini birleştiren benzersiz kariyer fırsatları.',

    // Blog page
    'blogpage.header.title': 'Blog & Makaleler',
    'blogpage.header.desc': 'Sağlık hukuku, tıbbi etik, bilimsel araştırma ve hikaye anlatıcılığı',
    'blogpage.filter.all': 'Tümü',
    'blogpage.filter.law': 'Sağlık Hukuku',
    'blogpage.filter.ethics': 'Tıbbi Etik',
    'blogpage.filter.science': 'Bilimsel Araştırma',
    'blogpage.filter.story': 'Hikaye & Senaryo',
  },
  en: {
    'nav.home': 'Home',
    'nav.about': 'About',
    ...
    'hero.name': 'Dr. Süleyman Alpar',
    'hero.subtitle': 'Medical Doctor | Health Law Expert | Screenwriter',
    'hero.tagline': '"Where science, law, and storytelling intersect"',
    'hero.badge1': 'Medical Doctor',
    'hero.badge2': 'Health Law',
    'hero.badge3': 'Screenwriter',
    'hero.badge4': 'Scientific Author',
    'hero.cta1': 'For Patients',
    'hero.cta2': 'For Students',

    'services.label': 'SERVICES',
    'services.title': 'What I Offer',
    'services.desc': 'Specialized services in medicine, law, and creative writing',
    ...
    'services.student.title': 'Student Resources',
    'services.student.desc': 'Lecture notes, case studies, and academic resources for medical students.',
    'services.blog.title': 'Blog & Articles',
    'services.blog.desc': 'In-depth articles on health law, medical ethics, and scientific topics.',
    'services.scenario.title': 'Screenplay & Stories',
    'services.scenario.desc': 'Medical dramas, health stories, and creative writing projects.',
    'services.more': 'Read more →',

    'about.label': 'ABOUT',
    'about.title': 'Who is Dr. Süleyman Alpar?',
    'about.p1': 'I am a versatile professional who combines medical practice with health law expertise, while actively pursuing screenwriting and storytelling.',
    'about.p2': 'My goal is to provide the best health information to my patients, build a strong academic foundation for my students, and touch people\'s lives through stories.',
    ...
    'blog.desc': 'Latest writings from the world of health, law, and storytelling',
    'blog.cat1': 'Health Law',
    'blog.cat2': 'Medical Ethics',
    'blog.cat3': 'Scientific Research',
    'blog.title1': 'Patient Rights and Recent Legislative Changes',
    'blog.desc1': 'Important changes in health law and what patients need to know.',
    ...
    'footer.desc': 'A personal website offering knowledge and inspiration at the intersection of medicine, law, and storytelling.',
    ...
    'student.note2.title': 'Health Law Lectures',
    'student.note2.desc': 'Medical malpractice, patient rights, physician liability, and health legislation.',
    'student.note2.tag': 'Law',
    ...
    'student.career3.title': 'Health Law Specialization',
    'student.career3.desc': 'Unique career opportunities combining medicine and law disciplines.',

    'blogpage.header.title': 'Blog & Articles',
    'blogpage.header.desc': 'Health law, medical ethics, scientific research, and storytelling',
    'blogpage.filter.all': 'All',
    'blogpage.filter.law': 'Health Law',
    'blogpage.filter.ethics': 'Medical Ethics',
    'blogpage.filter.science': 'Scientific Research',
    'blogpage.filter.story': 'Story & Screenplay',
  }
};
